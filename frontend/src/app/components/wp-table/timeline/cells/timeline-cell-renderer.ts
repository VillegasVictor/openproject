...
export class TimelineCellRenderer {
  ...
  public onMouseDownEnd(labels:WorkPackageCellLabels, change:WorkPackageChange) {
  ...
  protected assignDate(change:WorkPackageChange, attributeName:string, value:moment.Moment) {
    if (value) {
